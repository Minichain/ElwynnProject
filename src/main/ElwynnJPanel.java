...
//                                - (entity.getSprite().getRegionWidth() / 2),
//                        (int)localCoordinates[1]
//                                - (int)(entity.getSprite().getRegionHeight() * 0.75),
//                        entity.getSprite().getRegionWidth(),
//                        entity.getSprite().getRegionHeight(),
//                        null);
//
//                /** DEBUG ELEMENTS **/
...
//        graphics2D.drawImage(Scene.getInstance().getTile(0),
//                mouseX,
//                mouseY,
//                Parameters.getTilesSizeX(),
//                Parameters.getTilesSizeY(),
