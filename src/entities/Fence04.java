...
public class Fence04 extends StaticGraphicEntity {
    public static byte ENTITY_CODE = 24;

    public Fence04(int x, int y) {
        super(x, y);
        init();
    }
    ...
    private void init() {
        ...
        setSprite(SpriteManager.getInstance().FENCE04);
